        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-12" data-aos="zoom-in" data-aos-delay="400">
                ...
                <div class="pricing-item ">
                    <p class=" h3" style="text-align: center"> مركز حوار للدراسات والأبحاث| تقدير الموقف </p>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <img class="rounded mx-auto d-block" src='{{asset("storage/assets/img/versions/{$ver->imge}")}}' alt="" width="400" height="300">
                            </div>
                            <div class="col-1">
                            </div>
