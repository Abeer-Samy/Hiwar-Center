<header id="m_header" class="m-grid__item  
  m-header " m-minimize-offset="200" m-minimize-mobile-offset="200">
										...
										<li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
										 m-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												...
												<span class="m-topbar__username m--hide">علي</span>
											</a>
											<div class="m-dropdown__wrapper">
													...
													<div class="m-dropdown__body">
															...
															<ul class="m-nav m-nav--skin-light">
																...
																<li class="m-nav__item">
																	<a href="header/profile.html" class="m-nav__link">
																		...
																		<span class="m-nav__link-text">تغير كلمة المرور</span>
																	</a>
																</li>
                                                        ...
                                                        <form method="POST" action="{{ route('logout') }}">
                                                            ...
                                                            <a href="route('logout')"
                                                                ...
                                                                class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">{{trans('تسجيل خروج')}}</a>
