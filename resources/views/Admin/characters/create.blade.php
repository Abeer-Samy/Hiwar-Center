            ...
            <div class="m-portlet__body">
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="fullName" value="{{old('fullName')}}" class="form-control m-input" placeholder="أدخل الاسم رباعي ">
                        </div>
                    </div>
                </div>
                ...
                <div class="m-form__group form-group row">
                            ...
                            <input class="col-lg-6" type='file' name="profile_pic" id="profile_pic" />
                </div>
                ...
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="speciality" value="{{old('speciality')}}" class="form-control m-input" placeholder=" التخصص ">
                        </div>
                    </div>
                </div>
                ...
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="profile" value="{{old('profile')}}" class="form-control m-input" placeholder=" نبذه ">
                        </div>
                    </div>
                </div>
