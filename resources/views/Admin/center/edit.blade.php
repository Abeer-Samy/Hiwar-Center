            ...
            <div class="m-portlet__body">
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="center_name" value='{{old("center_name",$centers->center_name)}}' class="form-control m-input" placeholder="أدخل اسم المركز ">
                        </div>
                    </div>
                </div>
                ...
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="brief_discrption" value='{{old("brief_discrption",$centers->brief_discrption)}}' class="form-control m-input" placeholder=" ادخل وصف مختصر ">
                        </div>
                    </div>
                </div>
                ...
                <div class="m-form__group form-group row">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="vision" value='{{old("vision",$centers->vision)}}' class="form-control m-input" placeholder="ادخل الرؤية ">
                        </div>
                    </div>
                </div>
                ...
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="mission" value='{{old("mission",$centers->mission)}}' class="form-control m-input" placeholder=" الرسالة ">
                        </div>
                    </div>
                </div>
                ...
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="objectives" value='{{old("objectives",$centers->objectives)}}' class="form-control m-input" placeholder=" الاهداف ">
                        </div>
                    </div>
                </div>
                ...
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="center_location" value='{{old("center_location",$centers->center_location)}}' class="form-control m-input" placeholder=" مكان المركز ">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <select class="form-control chosen-rtl select" name='country_id' id='country_id'>
                                ...
                                <option value="{{$country->id}}">{{$country->countryName}} 
                                      {{$centers->country_id==$country->id?'selected':''}}</option>
                ...
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="date_establish" value='{{old("date_establish",$centers->date_establish)}}' class="form-control m-input" placeholder=" تاريخ انشاء المركز ">
                        </div>
                    </div>
                </div>
