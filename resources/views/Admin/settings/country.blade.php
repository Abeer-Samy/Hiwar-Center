            ...
            <div class="m-portlet__body">
                <div class="m-form__section m-form__section--first">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="countryName" value="{{old('countryName')}}" class="form-control m-input" placeholder="الدولة">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td width="15%">
                                    <a class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only"
                                        ...
                                        onclick="return confirm('هل انت متأكد من حذف {{$country->name}} ؟')" title="حذف"><i
